...
RETAILERS = [
    ...
    },
    {
        ...
        "membership": False,
        "free_delivery": (
            "No membership required. Same-day delivery fees vary by order and "
            "are often waived over ~$35; ExtraCare is free to join."
        ),
    },
    {
        "id": "walgreens",
        ...
        "membership": False,
        "free_delivery": (
            "No membership required. Same-day delivery fees vary; free-delivery "
            "promotions appear regularly (myWalgreens rewards is free)."
        ),
    },
    {
        "id": "wholefoods",
        ...
        "membership": False,
        "free_delivery": (
            "No membership required in store. Amazon Prime members get free "
            "Whole Foods delivery on orders over $35."
        ),
    },
    {
        "id": "traderjoes",
        ...
        "membership": False,
        "free_delivery": (
            "No membership; most Trader Joe's products are in-store only and "
            "not sold online for delivery."
        ),
    },
    {
        "id": "keyfood",
        ...
        "membership": False,
        "free_delivery": (
            "Local grocery chain; delivery options vary by store and are "
