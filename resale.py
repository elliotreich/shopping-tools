"""Read-only access to the Menswear Watcher SQLite store.
...
Menswear Watcher data. A missing file is an error, never a newly created
database.
...
# Score at or above which a listing counts as "high" (mirrors Menswear
